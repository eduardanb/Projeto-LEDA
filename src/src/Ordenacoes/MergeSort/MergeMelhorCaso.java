...
public class MergeMelhorCaso {
    ...
    // Método para ordenar um arquivo CSV no melhor caso usando Merge Sort
    public static void mergeSortCSVBestCase(String inputFilePath, String outputFilePath) throws IOException {
        ...
        // Preparar o melhor caso (ordenar os dados em ordem decrescente)
        prepareBestCase(lengths);
    ...
    public static void mergeSortCSVDataMes(String inputFilePath, String outputFilePath) throws IOException {
        ...
        // Preparar o melhor caso (ordenar os meses em ordem crescente)
        Arrays.sort(months);
    ...
    // Método para preparar o melhor caso (ordenar os dados em ordem decrescente)
    private static void prepareBestCase(int[] array) {
